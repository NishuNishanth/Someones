...
bot = telebot.TeleBot('7353432684:AAFmXXXOvSNQmXo2_AsHXFstQxM-YsqV-ac')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access!🚫Please buy access :-@kartik9457"
...
def welcome_start(message):
    ...
    response = f'''🫡WELCOME TO DEATH KILLER DDOS BOT 🚀 '''
    bot.reply_to(message, response)
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''
1. ANY PROBLEM DM HERE -> @GemarAju12345'''
    bot.reply_to(message, response)
